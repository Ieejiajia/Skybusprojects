...
class EditTickets extends StatefulWidget {
  ...
  const EditTickets({Key key, this.user, this.schedule}) : super(key: key);
...
class _EditTicketsState extends State<EditTickets> {
  ...
  super.initState();
  print("edit Tickets");
    departEditingController.text = widget.schedule.departurestation;
    arrivalEditingController.text = widget.schedule.arrivalstation;
    departimeEditingController.text = widget.schedule.departuretime;
    arrvtimeEditingController.text = widget.schedule.arrivaltime;
    priceEditingController.text = widget.schedule.price;
    qtyEditingController.text = widget.schedule.quantity;
    companyEditingController.text = widget.schedule.company;
    //selectedCompany = widget.schedule.company;
    print(companyEditingController.text);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Update Your Tickets'),
      ),
      body: Container(
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: CachedNetworkImage(
                          fit: BoxFit.fill,
                          imageUrl:
                              server+"/busimage/${widget.schedule.company}.jpg",
                          ...
                          decoration: BoxDecoration(
                            image: new DecorationImage(
                              colorFilter: new ColorFilter.mode(
                                  ...
                                  BlendMode.dstATop),
                              image:  _image == null
                              ? AssetImage('assets/image/phonecam.png')
                              :FileImage(_image),
                              fit: BoxFit.cover,
                            ),
                          ),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          title: new Text(
            "Update Ticket Id " + widget.schedule.id,
            style: TextStyle(
              color: Colors.black,
            ),
          ),
  ...
  updateProduct() {
    ...
    pr.style(message: "Updating ticket...");
    pr.show();
    String base64Image; 
    
    if (_image!=null){
       base64Image = base64Encode(_image.readAsBytesSync());
      http.post(server+"/php/update_bus.php", body: {
